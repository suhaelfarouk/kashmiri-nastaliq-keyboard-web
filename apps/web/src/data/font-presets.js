 ...
 *
 * Font and size are applied as CSS variables on the editor card. Exported
 * .docx files name the chosen face but do not embed the font file.
 *
...
export const FONT_PRESETS = [
  ...
  },
  {
    ...
    cssFamily: '"Faiz Lahori Nastaleeq Local", "Gulmarg Nastaliq", "Noto Nastaliq Urdu", serif',
    docxFont: "Faiz Lahori Nastaleeq",
    localOnly: true,
    lineHeight: 2,
  },
  {
...
/** Editor body sizes in px. Smaller steps sit below the 16 px default. */
export const FONT_SIZES = [12, 14, 16, 18, 20, 22, 24, 28, 32, 36, 42, 48];
